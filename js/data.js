...
window.SEED_TOPICS = [
  {
    ...
    qa: [
      { id:"t1q1", q:"Demir madeni hangi illerimizde çıkarılır?",  a:["Sivas","Malatya","Kayseri","Adana"], isImportant:true },
...
window.Store = {
  ...
  addQuestion(topicId, q) {
    ...
    const item = { id: uid(), q: q.q, a: q.a, isImportant: !!q.isImportant, media: null };
    t.qa.push(item);
    this.save();
  ...
  prefs()        { return _ls.get(CFG.LS.prefs, { dark:false, blind:false, regions:false, sound:true }); },
